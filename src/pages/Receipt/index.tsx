...
function Index() {
    ...
    useEffect(() => {
        fetchReceiptInfo();
        //Delay of 1s was added so the response from the promise can be gotten and the UI updated with the correct details before printing
        const interval = setTimeout(() => printWindow(), 1000);
